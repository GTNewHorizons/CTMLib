...
public interface ISubmapManager {
     ...
     * 
     * @param side Side of the ItemBlock.
     * @param meta Metadata of the ItemBlock.
    ...
    /**
     * Hook for registering any custom icons you might need in this class. Will be called during the normal block
     * method.
     * 
     * @param modName  The mod ID this submap was registered to.
     * @param block    The block being registered for.
     * @param register The IIconRegister instance.
     */
