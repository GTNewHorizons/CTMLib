...
public class CTM {
    ...
    /**
     * Builds the connection map and stores it in this CTM instance. The {@link #connected(Dir)},
     * {@link #connectedAnd(Dir...)}, and {@link #connectedOr(Dir...)} methods can be used to access it.
     */
     ...
     * @return True if the cached connectionMap holds a connection in <i><b>all</b></i> the given {@link Dir
     *         directions}.
     */
    ...
    /**
     * @param dirs The directions to check connection in.
     * @return True if the cached connectionMap holds a connection in <i><b>one of</b></i> the given {@link Dir
     *         directions}.
     */
     ...
     * @param y
     * @param z
     * @param side  The side to check for. -1 for unknown.
