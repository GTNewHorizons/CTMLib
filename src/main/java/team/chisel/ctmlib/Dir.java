 ...
 * <p>
 * It represents the eight different directions a face of a block can connect with CTM, and contains the logic for
 * determining if a block is indeed connected in that direction.
 * <p>
 * Note that, for example, {@link #TOP_RIGHT} does not mean connected to the {@link #TOP} and {@link #RIGHT}, but
 * connected in the diagonal direction represented by {@link #TOP_RIGHT}. This is used for inner corner rendering.
 */
public enum Dir {
     ...
     * 
     * @param inst    The CTM instance to use for logic.
     * @param world   The world the block is in.
     * @param x       The x coordinate of your block.
     * @param y       The y coordinate of your block.
     * @param z       The z coordinate of your block.
     * @param sideIdx The side index of the current face. This equivalent to {@link ForgeDirection#ordinal()}
